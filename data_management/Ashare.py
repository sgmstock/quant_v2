...
def get_price_sina(code, end_date='', count=10, frequency='60m'):    #新浪全周期获取函数    
    ...
    if (end_date!='') & (frequency in ['240m','1200m','7200m']): 
        ...
        return filtered_df.iloc[-mcount:]   #日线带结束时间先返回              
    return df
...
if __name__ == "__main__":
    print(get_price('000029.XSHE', count=1, frequency='1d'))
    # print(get_price_day_tx('000029', count=10, frequency='1d'))
    import akshare as ak
    stock_zh_a_hist_df = ak.stock_zh_a_hist(symbol="600519", period="daily", start_date="20250801", end_date='20250919', adjust="qfq")
